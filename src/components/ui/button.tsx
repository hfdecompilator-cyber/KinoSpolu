  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-danger text-white hover:bg-red-600 focus-visible:ring-danger",
        outline: "border border-border bg-transparent hover:bg-surface focus-visible:ring-primary",
        secondary: "bg-surface text-white hover:bg-secondary-light focus-visible:ring-surface",
        ghost: "hover:bg-surface focus-visible:ring-surface",
