...
function Navbar() {
  ...
  return (
    <nav className="border-b border-white/10 backdrop-blur-md bg-white/5 sticky top-0 z-40">
      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20">
          {[
            ...
            { title: "Plugins", desc: "Extend with Linear, Jira, Notion, and more", icon: "🔌" },
          ].map((feature) => (
            <div
              key={feature.title}
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {parties.map((party) => (
            <div
              key={party.id}
              className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-colors cursor-pointer"
            >
